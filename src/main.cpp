...
unsigned int nStakeMaxAge = 120 * 24 * 60 * 60;
...
const string strMessageMagic = "Amsterex Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Amsterex", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "AME Genesis Block - 19th of November 2019";
        CTransaction txNew;
        txNew.nTime = 1574128500;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        assert(block.hashMerkleRoot == uint256("0x061478d132b12522cea7514ad5c20768eb07ad5a8c5ef36b6faddb80bc80cba6"));        
		block.print();
...
unsigned char pchMessageStart[4] = { 0xd4, 0xc2, 0xc2, 0xa2 };
