...
void OptionsModel::Init()
{
    ...
    fUseAmsterexTheme = settings.value("fUseAmsterexTheme", true).toBool();
...
QVariant OptionsModel::data(const QModelIndex & index, int role) const
{
    if(role == Qt::EditRole)
    {
        ...
        case UseAmsterexTheme:
            return QVariant(fUseAmsterexTheme);
        default:
            return QVariant();
        }
    }
...
bool OptionsModel::setData(const QModelIndex & index, const QVariant & value, int role)
{
    ...
    if(role == Qt::EditRole)
    {
        ...
        case CoinControlFeatures: {
            ...
            break;
        case UseAmsterexTheme:
            fUseAmsterexTheme = value.toBool();
            settings.setValue("fUseAmsterexTheme", fUseAmsterexTheme);
            break;
        default:
            break;
        }
