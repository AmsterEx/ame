	...
	multisendDialog(0)
{
    updateStyle();
    resize(1080, 710);
    setWindowTitle(tr("Amsterex [AME]") + " - " + (QString::fromStdString(FormatFullVersion()).split("-")[0]));
	QFontDatabase fontData;
	fontData.addApplicationFont(":/fonts/amefont");
#ifndef Q_OS_MAC
...
void BitcoinGUI::createActions()
{
    ...
    overviewAction = new QAction(QIcon(":/icons/overview"), tr("&Portfolio"), this);
    overviewAction->setToolTip(tr("Show general overview of your portfolio"));
    overviewAction->setCheckable(true);
    overviewAction->setShortcut(QKeySequence(Qt::ALT + Qt::Key_1));
    tabGroup->addAction(overviewAction);

    sendCoinsAction = new QAction(QIcon(":/icons/send2"), tr("&Send"), this);
    sendCoinsAction->setToolTip(tr("Send Amsterex Shares"));
    sendCoinsAction->setCheckable(true);
    sendCoinsAction->setShortcut(QKeySequence(Qt::ALT + Qt::Key_2));
    tabGroup->addAction(sendCoinsAction);

    receiveCoinsAction = new QAction(QIcon(":/icons/receiving_addresses2"), tr("&Receive"), this);
    receiveCoinsAction->setToolTip(tr("Show the list of addresses for receiving Amsterex Shares"));
    ...
    statisticsAction = new QAction(QIcon(":/icons/statistics"), tr("&Network"), this);
	...
	resourcesAction = new QAction(QIcon(":/icons/resources"), tr("&Resources"), this);
    resourcesAction ->setToolTip(tr("Information and links about Amsterex "));
    ...
    aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About Amsterex"), this);
    aboutAction->setStatusTip(tr("Show information about Amsterex"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/icons/qt"), tr("About &Qt"), this);
    aboutQtAction->setStatusTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setStatusTip(tr("Modify configuration options for Amsterex"));
	...
	stakeReportAction = new QAction(QIcon(":/icons/stakejournal"), tr("Staking Log"), this);
    stakeReportAction->setToolTip(tr("Read your staking log"));
...
void BitcoinGUI::createToolBars()
{
	...
	QToolBar *toolbar = addToolBar(tr("Amsterex top-logo"));
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("Amsterex core") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("Amsterex core"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("Amsterex Network<br><br>Connections: <b>%n</b>", "", count));
}
...
void BitcoinGUI::setNumBlocks(int count, int nTotalBlocks)
{
    ...
    if (!clientModel || clientModel->getNumConnections() == 0)
    {
		...
		tooltip = tr("You are not connected to the Amsterex network");
        return;
    }
...
void BitcoinGUI::updateStakingIcon()
{
    ...
    {
        labelStakingIcon->setToolTip(tr("You are not minting AME: <b>Your wallet is locked</b><br>Amsterex Network Weight: <b>%1</b><br>MultiSend: <b>%2</b>").arg(nNetworkWeight).arg(fMultiSend ? tr("Active"):tr("Inactive")));
        labelStakingIcon->setEnabled(false);
        labelStakingIcon->setPixmap(QIcon(":/icons/staking_off").pixmap(32,32));
    }
    else if (vNodes.empty())
    {
        labelStakingIcon->setToolTip(tr("You are not minting AME: <b>Your wallet is offline</b><br>Amsterex Network Weight: <b>%1</b><br>MultiSend: <b>%2</b>").arg(nNetworkWeight).arg(fMultiSend ? tr("Active"):tr("Inactive")));
        labelStakingIcon->setEnabled(false);
        labelStakingIcon->setPixmap(QIcon(":/icons/staking_off").pixmap(32,32));
    }
    else if (IsInitialBlockDownload())
    {
        labelStakingIcon->setToolTip(tr("You are not minting AME: <b>Your wallet is syncing with the Amsterex network</b><br>Amsterex Network Weight: <b>%1</b><br>MultiSend: <b>%2</b>").arg(nNetworkWeight).arg(fMultiSend ? tr("Active"):tr("Inactive")));
        labelStakingIcon->setEnabled(false);
        labelStakingIcon->setPixmap(QIcon(":/icons/staking_off").pixmap(32,32));
    }
    else if (!nWeight)
    {
        labelStakingIcon->setToolTip(tr("You are not minting AME: <b>You don't have mature coins</b><br>Amsterex Network Weight: <b>%1</b><br>MultiSend: <b>%2</b>").arg(nNetworkWeight).arg(fMultiSend ? tr("Active"):tr("Inactive")));
        labelStakingIcon->setEnabled(false);
        labelStakingIcon->setPixmap(QIcon(":/icons/staking_off").pixmap(32,32));
    }
    ...
    {
        labelStakingIcon->setToolTip(tr("You are not minting AME.<br>Amsterex Network Weight: <b>%1</b>").arg(nNetworkWeight));
        labelStakingIcon->setEnabled(false);
        labelStakingIcon->setPixmap(QIcon(":/icons/staking_off").pixmap(32,32));
    }
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid Amsterex address or malformed URI parameters."));
    }
...
{
    if (!fUseAmsterexTheme)
        return;

    QString qssPath = QString::fromStdString( GetDataDir().string() ) + "/amsterex.qss";
